    ...
    <section id="features" className="gradient-hero py-12 md:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span className="text-tennessee text-sm font-semibold uppercase tracking-wide">Scientific Gamification</span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mb-4">
            ...
            <p className="text-foreground text-sm text-center mt-2 md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 md:max-w-[200px] md:text-left">
              <span className="text-tennessee font-semibold">Must Have</span> - ลบไม่ได้ กำหนดทิศทางและสิ่งที่ต้องทำ
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
          <div className="bg-oxford-blue border border-border/30 rounded-xl p-6 text-center hover:border-tennessee/40 transition-colors duration-200">
            <p className="text-muted-foreground text-sm">ROLE ลบแล้ว</p>
          ...
          <div className="bg-oxford-blue border border-border/30 rounded-xl p-6 text-center hover:border-tennessee/40 transition-colors duration-200">
            <p className="text-muted-foreground text-sm">TARGET ลบแล้ว</p>
            <p className="text-tennessee text-3xl font-bold mt-2">-28 Points</p>
          </div>
          <div className="bg-oxford-blue border border-border/30 rounded-xl p-6 text-center hover:border-tennessee/40 transition-colors duration-200">
            <p className="text-muted-foreground text-sm">FORMAT ลบแล้ว</p>
            <p className="text-muted-foreground text-3xl font-bold mt-2">-8 Points</p>
