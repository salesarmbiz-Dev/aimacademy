...
const B2BSolutionSection: React.FC = () => {
  return (
    <section 
      ...
      style={{
        background: 'linear-gradient(180deg, #012840 0%, rgba(242, 116, 5, 0.03) 50%, #012840 100%)'
      }}
    >
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 pb-16 border-b border-border/30">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-5 bg-tennessee/[0.08] border-l-[3px] border-tennessee rounded-xl px-5 py-3 inline-block">
              <span className="text-foreground text-[15px]">
                <span className="font-bold text-tennessee">92%</span> Completion Rate 
          ...
          <div className="flex-1 w-full max-w-md lg:max-w-none">
            <div className="bg-oxford-blue/80 border border-border/30 rounded-2xl p-5 shadow-lg">
              <div className="text-xs text-muted-foreground mb-3">Spot the Difference</div>
              ...
              <div className="flex justify-center mt-4">
                <span className="bg-tennessee/20 text-tennessee text-xs px-3 py-1 rounded-full font-medium">
                  +10 XP
                </span>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-12 py-16 border-b border-border/30">
          <div className="flex-1 text-center lg:text-left">
            <h3 className="text-2xl font-semibold text-foreground">
            ...
            <div className="mt-5 bg-tennessee/[0.08] border-l-[3px] border-tennessee rounded-xl px-5 py-3 inline-block">
              <span className="text-foreground text-[15px]">
                เฉลี่ย <span className="font-bold text-tennessee">+23%</span> Skill Improvement 
                หลังเรียน 2 สัปดาห์
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-md lg:max-w-none">
            <div className="bg-oxford-blue/80 border border-border/30 rounded-2xl p-5 shadow-lg">
              <div className="text-xs text-muted-foreground mb-3">Skill Assessment</div>
              ...
              <div className="flex justify-center gap-6 mt-2">
                ...
                <div className="flex items-center gap-1.5 text-[11px]">
                  <span className="w-2 h-2 rounded-full bg-tennessee" />
                  <span className="text-tennessee">Post-test</span>
                </div>
              </div>
              <div className="text-center mt-3 text-tennessee text-[13px] font-medium">
        ...
        <div id="demo-section" className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 pt-16">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-5 bg-tennessee/[0.08] border-l-[3px] border-tennessee rounded-xl px-5 py-3 inline-block">
              <span className="text-foreground text-[15px]">
                ใช้เวลา <span className="font-bold text-tennessee">&lt; 5 นาที</span> ดูความก้าวหน้าทั้งทีม
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-md lg:max-w-none">
            <div className="bg-oxford-blue/80 border border-border/30 rounded-2xl p-5 shadow-lg">
              <div className="text-xs text-muted-foreground mb-3">Team Engagement</div>
              ...
              {/* Mini Member Table */}
              <div className="text-xs text-muted-foreground mb-2">Member Progress</div>
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={i} className="grid grid-cols-4 gap-2 text-[11px] py-1.5 px-2 bg-rackley/5 rounded">
                    ...
                    <span className="text-muted-foreground">Pre {member.pre}</span>
                    <span className="text-muted-foreground">Post {member.post}</span>
              ...
              <div className="flex gap-2 mt-4 justify-end">
                <button className="text-[10px] text-muted-foreground border border-border/30 rounded px-2 py-1 hover:bg-rackley/10 transition-colors">
                  CSV
                </button>
                <button className="text-[10px] text-muted-foreground border border-border/30 rounded px-2 py-1 hover:bg-rackley/10 transition-colors">
                  PDF
